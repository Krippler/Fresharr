...
OPTION_DEFS: list[OptionDef] = [
    ...
    OptionDef("radarr_root_folder", "Root folder", RADARR, "str",
              "", select="root_folders"),
    OptionDef("radarr_anime_root_folder", "Anime root folder", RADARR, "str",
              "Optional · anime movies go here instead of the main folder",
              select="root_folders"),
    ...
    OptionDef("sonarr_root_folder", "Root folder", SONARR, "str",
              "", select="root_folders"),
    OptionDef("sonarr_anime_root_folder", "Anime root folder", SONARR, "str",
              "Optional · anime series go here instead of the main folder",
              select="root_folders"),
    ...
    OptionDef("metacritic_min_score_movies", "Min Metascore (movies)", "metacritic", "int",
              "0-100", min=0, max=100),
    OptionDef("metacritic_min_score_tv", "Min Metascore (TV)", "metacritic", "int",
              "0-100", min=0, max=100),
    ...
    OptionDef("tmdb_min_rating_movies", "Min rating (movies)", "tmdb", "float",
              "0-10", min=0, max=10),
    OptionDef("tmdb_min_rating_tv", "Min rating (TV)", "tmdb", "float",
              "0-10", min=0, max=10),
    ...
    OptionDef("trakt_min_rating_movies", "Min rating (movies)", "trakt", "float",
              "0-10", min=0, max=10),
    OptionDef("trakt_min_rating_tv", "Min rating (TV)", "trakt", "float",
              "0-10", min=0, max=10),
